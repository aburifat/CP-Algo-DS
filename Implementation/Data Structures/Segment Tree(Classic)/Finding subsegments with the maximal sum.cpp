...
int main()
{
    ...
    for(ll i=1;i<=q;i++){
        ...
        if(tp=='q'){
            ...
            cout<<"Result of this Query :: "<<endl;
            cout<<"Sum of the segment : "<<ans.sum<<endl;
            cout<<"Max Prefix sum of the segment : "<<ans.pref<<endl;
            cout<<"Max Suffix sum of the segment : "<<ans.suff<<endl;
            cout<<"Max subsegment sum of the segment : "<<ans.ans<<endl;
            cout<<endl;
        }else if(tp=='u'){
            cin>>pos>>val;
